...
require_once DIDAR_PATH . 'includes/class-didar-notification-event-registry.php';
...
require_once DIDAR_PATH . 'includes/class-didar-readable-value-serializer.php';
require_once DIDAR_PATH . 'includes/class-didar-notification-channel-interface.php';
require_once DIDAR_PATH . 'includes/class-didar-notification-queue.php';
